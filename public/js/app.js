!function (s) {
    ...
    function a(e) {
        document.getElementById("header-lang-img") && ("eng" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/us.jpg" : "sp" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/spain.jpg" : "gr" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/germany.jpg" : "it" == e ? document.getElementById("header-lang-img").src = "assets/images/flags/italy.jpg" : "ru" == e && (document.getElementById("header-lang-img").src = "assets/images/flags/russia.jpg"),
    ...
    function o(e) {
        1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (s("#dark-mode-switch").prop("checked", !1),
            s("#rtl-mode-switch").prop("checked", !1),
            s("#bootstrap-style").attr("href", asset_url + "assets/css/bootstrap.min.css"),
            s("#app-style").attr("href", asset_url + "assets/css/app.min.css"),
            sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (s("#light-mode-switch").prop("checked", !1),
                s("#rtl-mode-switch").prop("checked", !1),
                s("#bootstrap-style").attr("href", asset_url + "assets/css/bootstrap-dark.min.css"),
                s("#app-style").attr("href", asset_url + "assets/css/app-dark.min.css"),
                sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (s("#light-mode-switch").prop("checked", !1),
                    ...
                    s("#bootstrap-style").attr("href", asset_url + "assets/css/bootstrap.min.css"),
                    s("#app-style").attr("href", asset_url + "assets/css/app-rtl.min.css"),
    ...
    s("#side-menu").metisMenu(),
        ...
        s(document).ready(function () {
            ...
            0 < s("#sidebar-menu").length && 0 < s("#sidebar-menu .mm-active .active").length && (300 < (e = s("#sidebar-menu .mm-active .active").offset().top) && (e -= 300,
                s(".simplebar-content-wrapper").animate({
                    scrollTop: e
                }, "slow")))
        }),
        ...
        window.sessionStorage && ((e = sessionStorage.getItem("is_visited")) ? (s(".right-bar input:checkbox").prop("checked", !1),
            s("#" + e).prop("checked", !0),
            o(e)) : sessionStorage.setItem("is_visited", "light-mode-switch")),
